...
#ifndef LAN8742_FOR_8720_H
#define LAN8742_FOR_8720_H

#define USER_USE_LAN8720
...
#define LAN8742_ANLPAR_ACKNOWLEDGE          ((uint16_t)0x4000U)  // special
#define LAN8742_ANLPAR_REMOTE_FAULT         ((uint16_t)0x2000U)
#define LAN8742_ANLPAR_PAUSE_OPERATION      ((uint16_t)0x0400U)
...
#define LAN8742_ANLPAR_100BASE_T4           ((uint16_t)0x0200U)
...
#define LAN8742_ANLPAR_SELECTOR_FIELD       ((uint16_t)0x001FU)
/**
  * @}
  */
